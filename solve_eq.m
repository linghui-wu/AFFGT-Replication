...
P_u_ji = x(6) ^ 2 ^ (1 / (1 - theta)) * (1 + t_u_ji) * p_u_ji;
P_u_ij = x(5) ^ 2 ^ (1 / (1 - theta)) * (1 + t_u_ij) * p_u_ij;
P_u_ii = x(5) ^ 2 ^ (1 / (1 - theta)) * (1 + t_u_ii) * p_u_ii;
P_u_jj = x(6) ^ 2 ^ (1 / (1 - theta)) * (1 + t_u_jj) * p_u_jj;
