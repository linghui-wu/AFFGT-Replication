...
P_u_ji = M_d_j ^ (1 / (1 - theta)) * (1 + t_u_ji) * p_u_ji;
P_u_ij = M_d_i ^ (1 / (1 - theta)) * (1 + t_u_ij) * p_u_ij;
P_u_ii = M_d_i ^ (1 / (1 - theta)) * (1 + t_u_ii) * p_u_ii;
P_u_jj = M_d_j ^ (1 / (1 - theta)) * (1 + t_u_jj) * p_u_jj;
