...
P_d_jj = M_d_i ^ (1 / (1 - sigma)) * (1 + t_d_jj) * p_d_jj;
...
% BB_i = T_i  - ... 
%      (t_d_ii * M_d_i * c_ii * p_d_ii + ...
%      t_u_ii * M_d_i * M_u_i * x_ii * p_u_ii - ...
%      v_d_ii * M_d_i * c_ii * p_d_ii - ...
%      v_u_ii * M_u_i * M_u_j * x_ii * p_u_ii + ...
%      t_d_ji * M_d_j * c_ji * p_d_ji + ...
%      t_u_ji * M_d_i * M_u_j * x_ji * p_u_ji - ...
%      v_d_ji * M_d_i * c_ij * p_d_ij - ...
%      v_u_ij * M_d_j * M_u_j * x_ij * p_u_ij);
% BB_j = T_j; % - ...
