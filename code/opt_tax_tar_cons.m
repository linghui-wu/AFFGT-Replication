%% Define optimal tariff and domestic subsidy constraints
function[cons, ceq]=opt_tax_tar_cons(x,params)
%% Set params
...
t_u_ii = -x(10)^2; t_u_ij = 0;  % Local tax on upstream goods in country i
